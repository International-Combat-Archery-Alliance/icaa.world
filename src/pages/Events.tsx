    ...
    <section id="events-section" className="content-section events-section">
      ...
      <div className="content-wrapper">
        ...
        <div className="event-grid">
          <Link
            to="/events/boston-play-ins"
            data-event="boston-play-ins"
            className="event-card"
          >
            <img
              src="images/logos/boston 2025.png"
          ...
          <Link
            to="/events/boston-championship"
            data-event="boston-championship"
            className="event-card"
          >
            <img
              src="images/logos/boston 2025.png"
          ...
          <Link
            to="/events/catch-2026"
            data-event="catch-2026"
            className="event-card"
          >
            <img
              src="images/logos/catch 2026.png"
              alt="C.A.T.C.H. 2026 Logo"
              className="event-logo"
            />
