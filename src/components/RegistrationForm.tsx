  ...
  return (
    ...
    >
      ...
      >
        ...
        <option value="member-class-1">
          Official ICAA Organization Member
        </option>
      ...
      {(regType === 'member-class-1' || regType === 'member-class-2') && (
        <>
          <label id="group-name-label" htmlFor="group-name">
            Group Name *
          </label>
          <input
            type="text"
            ...
            className={groupNameError ? 'error-border' : ''}
          />
          {groupNameError && (
            <span id="group-name-error" className="error-message">
